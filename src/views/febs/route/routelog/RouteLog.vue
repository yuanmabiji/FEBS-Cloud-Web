<template>
  <div class="app-container">
    <el-alert
      ...
      title="网关转发请求日志，这些为未被限流或黑名单规则拦截的请求"
      type="info"
      :closable="false"
    />
    <div class="filter-container">
      <el-input v-model="queryParams.ip" placeholder="请求IP" class="filter-item search-item" />
      <el-input v-model="queryParams.targetServer" placeholder="目标服务" class="filter-item search-item" />
    ...
    >
      ...
      <el-table-column label="目标URI" prop="targetUri" :show-overflow-tooltip="true" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="目标服务" prop="targetServer" :show-overflow-tooltip="true" align="center">
        <template slot-scope="scope">
